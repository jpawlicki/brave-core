...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
      ...
      {"braveAccountPasswordStrengthMeterTooltipTitle",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_TITLE},
      {"braveAccountPasswordStrengthMeterTooltipLowercaseRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_LOWERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthMeterTooltipUppercaseRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_UPPERCASE_REQUIREMENT},
      {"braveAccountPasswordStrengthMeterTooltipNumberRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_NUMBER_REQUIREMENT},
      {"braveAccountPasswordStrengthMeterTooltipSpecialCharacterRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_SPECIAL_CHARACTER_REQUIREMENT},
      {"braveAccountPasswordStrengthMeterTooltipLengthRequirement",
       IDS_SETTINGS_BRAVE_ACCOUNT_PASSWORD_STRENGTH_METER_TOOLTIP_LENGTH_REQUIREMENT},
