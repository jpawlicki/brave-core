...
class GettingStartedHelperTest : public testing::Test {
 protected:
  void AddSuccessResponse() {
    auto url = GetEducationPageServerURL(EducationPageType::kGettingStarted);
...
TEST_F(GettingStartedHelperTest, WithDefaultPageType) {
  ...
  EXPECT_EQ(result.value(),
            GetEducationPageBrowserURL(EducationPageType::kGettingStarted));
}
