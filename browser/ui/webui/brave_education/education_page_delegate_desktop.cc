...
void EducationPageDelegateDesktop::OpenRewardsPanel() {
  // TODO(https://github.com/brave/brave-browser/issues/42179): Rewards panel
  // functionality should be exposed via `BrowserWindowFeatures`.
  if (auto* browser = chrome::FindBrowserWithTab(tab_->GetContents())) {
