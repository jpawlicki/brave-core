...
@MainActor class URLFormatTests: XCTestCase {
  ...
  func testSecurityLTRAndRTLRendering() {
    XCTAssertTrue(URL(string: "https://brave.com")!.isLTRRendered)
    XCTAssertTrue(
      URL(
        string:
    ...
    XCTAssertTrue(URL(string: "about:blank%23https://accounts.google.com")!.isLTRRendered)
    XCTAssertFalse(
      URL(string: "https://xn--llb.login.wwww.accounts.google.com.xn--llb.pwr.wtf/")!.isLTRRendered
    )
    XCTAssertTrue(URL(string: "about:blank%23https://accounts.google.com")!.isLTRRendered)

    XCTAssertTrue(
      URL(string: "https://com.xn--mgbh0fb.xn--mgberp4a5d4ar/%D9%A0/1100068049663")!.isLTRRendered
    )
    XCTAssertTrue(
      URL(
        string:
    ...
    XCTAssertFalse(URL(string: "https://xn--mgbh0fb.xn--mgberp4a5d4ar/")!.isLTRRendered)
    XCTAssertFalse(
      URL(
        string:
